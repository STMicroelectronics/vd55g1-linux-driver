...
#define VD55G1_REG_TEMPERATURE				VD55G1_REG_16BIT(0x004c)
...
#define VD55G1_REG_MANUAL_ANALOG_GAIN			VD55G1_REG_8BIT(0x044d)
#define VD55G1_REG_MANUAL_COARSE_EXPOSURE		VD55G1_REG_16BIT(0x044e)
#define VD55G1_REG_MANUAL_DIGITAL_GAIN			VD55G1_REG_16BIT(0x0450)
				   ...
				   int gpio)
{
	...
	return vd55g1_write_reg(sensor, VD55G1_REG_GPIO_0_CTRL + gpio,
				index2val[mode], NULL);
}
...
static int vd55g1_apply_exposure_auto(struct vd55g1_dev *sensor)
{
	...
	return vd55g1_write_reg(sensor, VD55G1_REG_EXP_MODE, exp, NULL);
}
...
{
	return vd55g1_write_reg(sensor, VD55G1_REG_FRAME_LENGTH,
					  ...
					  int pedestal)
{
	...
	if (sensor->streaming)
		return vd55g1_write_reg(sensor, VD55G1_REG_DARKCAL_PEDESTAL,
